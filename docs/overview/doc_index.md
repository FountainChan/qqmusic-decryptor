...
| 文档 | 路径 | 说明 |
|------|------|------|
| **问题解决记录** | `docs/problem_solved.md` | ⭐ 所有问题及其解决方案 |
...
- **解决问题** → 阅读 `docs/problem_solved.md`
...
| 问题 | 解决方案 |
|------|----------|
| **输出目录错误** | 详见 `docs/problem_solved.md` - 问题1 |
| **目录结构未保留** | 详见 `docs/problem_solved.md` - 问题2 |
...
1. 阅读 `docs/problem_solved.md` 查找问题
...
**新增**:
- ✅ `docs/SHELL_SCRIPTS_GUIDE.md` - Shell脚本使用指南
