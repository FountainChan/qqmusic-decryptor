...
- **封面保存位置修复文档**：`doc/封面保存位置修复实施方案.md`（已实现）
...
- **实施计划**：本文档（`doc/API调用异常修复方案.md`）
- **跳过逻辑修复方案**：`doc/跳过逻辑修复方案.md`（待创建）
- **测试方案**：`doc/API调用异常测试方案.md`（待创建）
- **OGG 支持文档**：`doc/OGG_METADATA_IMPLEMENTATION_RESULT.md`（已实现）
